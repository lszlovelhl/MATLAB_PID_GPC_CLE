...
c=data(63,:);    %阀门设定值（下均热段煤气阀门开度设定值，下均热段空气阀门开度反馈值）
d=data(64,:);    %阀门测量值（下均热段煤气阀门开度反馈值，下均热段空气阀门开度反馈值）
figure(1);
subplot(2,1,1)
plot(a,'r');
hold on
...
c=data(61,:);   %阀门设定值（下均热段空气阀门开度设定值，下均热段空气阀门开度反馈值）
d=data(62,:);   %阀门测量值（下均热段空气阀门开度反馈值，下均热段空气阀门开度反馈值）
subplot(2,1,1)
plot(a,'r');
hold on
plot(b);
