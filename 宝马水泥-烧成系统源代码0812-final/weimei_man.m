...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global fjl_mode man_weimei
global yaowei_coalMAX yaowei_coalMIN man_in_fjl man_fjl_time_cnt
if fjl_mode == true
    fjl_mode = false;
    temp_man_weimei = str2double(get(handles.edit1,'String'));
    man_in_fjl = true;
    if temp_man_weimei > yaowei_coalMAX || temp_man_weimei < yaowei_coalMIN
