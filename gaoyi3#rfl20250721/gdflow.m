...
global gd_gas1 gas_lower1 paramdata
gd_gas1_max = paramdata.commdata(1).parameter(2).ATTRIBUTE.gd_gas1_max;
set(handles.text2,'String',gd_gas1);
set(handles.slider1,'Value',gd_gas1);
set(handles.slider1,'Max',gd_gas1_max,'Min',gas_lower1);
set(handles.slider1,'SliderStep',[1000/(gd_gas1_max-gas_lower1),5000/(gd_gas1_max-gas_lower1)]);
...
global burning autoswitch daobj autoshaolu gap_on gd_gas1
if burning(1) == 1&&strcmp(daobj.Status,'connected')
    gd_gas1 = str2double(get(handles.text2,'String'));
    set(handles.text2,'String',gd_gas1);
    set(handles.slider1,'Value',gd_gas1);
    if temp_open(1)==0    
     left_time(1)=-1;
