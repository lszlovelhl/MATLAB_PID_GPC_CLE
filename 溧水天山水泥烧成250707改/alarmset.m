...
set(handles.slider4,'Max',snd_chamber_pressure_upperlimitS+2000,'Min',snd_chamber_pressure_upperlimitS-2000);
set(handles.slider4,'SliderStep',[50/4000,100/4000]);

set(handles.text15,'String',snd_chamber_pressure_lowerlimitS);
set(handles.slider5,'Value',snd_chamber_pressure_lowerlimitS);
set(handles.slider5,'Max',snd_chamber_pressure_lowerlimitS + 2000,'Min',snd_chamber_pressure_lowerlimitS - 2000);
set(handles.slider5,'SliderStep',[50/4000,100/4000]);
