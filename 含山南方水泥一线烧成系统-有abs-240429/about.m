...
% Last Modified by GUIDE v2.5 20-May-2015 21:27:17
...
imshow(a);
% load('key');
% usedtime_num=decodekey(key.usedtime);
% set(handles.usedtime,'String',num2str(usedtime_num));
...
set(handles.usedtime,'String',num2str(usedtime));
