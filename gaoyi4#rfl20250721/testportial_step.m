             ...
             switch i
                case 1
                     if((tp_real(i)<tsp(i)-3)&&(gdtemp(i,1)-gdtemp(i,2)<=-0.15)&&time_airgaspotial(i)~=0)
                         ...
                         default_airgaspotial(i)=default_airgaspotial(i)-0.04;
                          tem_dec_flag(i)=1;
                     elseif ((tp_real(i)<tsp(i)-3)&&(tem_dec_flag(i)==1)&&(time_airgaspotial(i)==0))
                              default_airgaspotial(i)=default_airgaspotial(i)+0.08;
                     end
                 case 2
                    if((tp_real(i)<tsp(i)-3)&&(gdtemp(i,1)-gdtemp(i,2)<=-0.15)&&time_airgaspotial(i)~=0)
...
for i=1:3
 ...
 for i=1:3      %根据空燃比配空气流量
     ...
     switch i
         case 1                              % 1#
             if(tp1>ts1+3&&tp1<ts1+6)
                 default_airgaspotial(1)=good_airgaspotial(1)+0.03;
             else if(tp1>=ts1+6&&tp1<ts1+9)
                     default_airgaspotial(1)=good_airgaspotial(1)+0.06;
                 else if(tp1>=ts1+9&&tp1<ts1+12)
                         default_airgaspotial(1)=good_airgaspotial(1)+0.09;
                     else if(tp1>=ts1+12)
                             default_airgaspotial(1)=good_airgaspotial(1)+0.12;
                         else
             ...
             if(temp_open(i) ==0)
                default_airgaspotial(i)=min_airgaspotial(i);
%                 default_airgaspotial(i)=round(now_potial(i)*100)/100;
%                 if default_airgaspotial(i)<min_airgaspotial(i)
%                 default_airgaspotial(i)=min_airgaspotial(i);
%                  good_airgaspotial(i)=default_airgaspotial(i);
%                 end 
...
%                end
         ...
         case 2                                  % 2#
             if(tp2>ts2+3&&tp2<ts2+6)
                 default_airgaspotial(2)=good_airgaspotial(2)+0.03;
             else if(tp2>=ts2+6&&tp2<ts2+9)
                     default_airgaspotial(2)=good_airgaspotial(2)+0.06;
                 else if(tp2>=ts2+9&&tp2<ts2+12)
                         default_airgaspotial(2)=good_airgaspotial(2)+0.09;
                     else if(tp2>=ts2+12)
                             default_airgaspotial(2)=good_airgaspotial(2)+0.12;
                         else
...
%                end
         ...
         case 3                                  % 3#
             if(tp3>ts3+3&&tp3<ts3+6)
                 default_airgaspotial(3)=good_airgaspotial(3)+0.03;
             else if(tp3>=ts3+6&&tp3<ts3+9)
                     default_airgaspotial(3)=good_airgaspotial(3)+0.06;
                 else if(tp3>=ts3+9&&tp3<ts3+12)
                         default_airgaspotial(3)=good_airgaspotial(3)+0.09;
                     else if(tp3>=ts3+12)
                             default_airgaspotial(3)=good_airgaspotial(3)+0.12;
                         else
