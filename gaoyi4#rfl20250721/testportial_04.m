...
global older_default_airgaspotial old_default_airgaspotial side older_gdwendu old_gdwendu
%clear all
...
if b>50
    if(mod(b,se_op_time)==0)
         for i=1:3
             switch i
                case 1
                     if((tp_real(i)<tsp(i)-3)&&(gdtemp(i,1)-gdtemp(i,2)<=-0.2)&&time_airgaspotial(i)~=0)
                     ...
                     elseif ((tp_real(i)<tsp(i)-3)&&(tem_dec_flag(i)==1)&&(time_airgaspotial(i)==0))
                              default_airgaspotial(i)=default_airgaspotial(i)+0.1;
                     end
                 case 2
                    if((tp_real(i)<tsp(i)-3)&&(gdtemp(i,1)-gdtemp(i,2)<=-0.2)&&time_airgaspotial(i)~=0)
                         time_airgaspotial(i)=se_op_time;
                         default_airgaspotial(i)=default_airgaspotial(i)-0.5;
                         tem_dec_flag(i)=1;
                    elseif ((tp_real(i)<tsp(i)-3)&&(tem_dec_flag(i)==1)&&(time_airgaspotial(i)==0))
                          default_airgaspotial(i)=default_airgaspotial(i)+0.1;
                    end 
 ...
 for i=1:3      %根据空燃比配空气流量
     ...
     switch i
         case 1                              % 1#
             ...
             else if(gdwendu(i)>=ts1+6&&gdwendu(i)<ts1+9)
...
%                 
 ...
 for i=1:3
    ...
    if default_airgaspotial(i)>max_airgaspotial(i)
       ...
       a_his_airgaspotial(i,b+1)=default_airgaspotial(i);%%deletedata
 end
for i=1:3
    if old_default_airgaspotial(i)~=default_airgaspotial(i)
     ...
     a_side(i,b+1)=side(i); %%deletedata
end
 test1=b;
end