...
global gas_co
global dt
global flow_buchang  temp_Test coswitch  manauto modtime singlechange
global default_airgaspotial_set2 default_airgaspotial2 zeng1 zeng2 zeng3 gd_gas1 gd_gas2 gd_gas3
...
try
    ...
    if ~errortag
        ...
        manauto = paramdata.commdata(1).parameter(2).ATTRIBUTE.manauto;
        modtime = paramdata.commdata(1).parameter(2).ATTRIBUTE.modtime;
        singlechange = paramdata.commdata(1).parameter(2).ATTRIBUTE.singlechange;
        zeng1 = paramdata.commdata(1).parameter(2).ATTRIBUTE.zeng1;
        zeng2 = paramdata.commdata(1).parameter(2).ATTRIBUTE.zeng2;
        zeng3 = paramdata.commdata(1).parameter(2).ATTRIBUTE.zeng3;
        time = datestr(clock,'HH');
        time1 = '19';
        time2 = '20';
        tf1 = strcmp(time,time1);
        tf2 = strcmp(time,time2);
        % day = paramdata.commdata(1).parameter(2).ATTRIBUTE.day;
        % clear_flow = datestr(date,7);
        % if manauto == 0  % && (day ~= clear_flow)
        %     if mod(b,modtime) == 0 &&...
        %         data(15,b+1) >= 500000 && data(7,b+1) >= 200000 && data(26,b+1) >= 200000 && data(45,b+1) >= 200000 &&...
        %         ~(tf1 == 1 || tf2 == 1)
        %
        %         %支管量除以2
        %         singlechangereal = singlechange / 2;
        %         %煤气总流量
        %         if data(12,b+1) + data(31,b+1) + data(50,b+1) >= 20000
        %             writeasync(itemset(15),data(15,b+1)+singlechange);
        %         end
        %         %煤气支管流量
        %         if data(12,b+1) >= 10000
        %             writeasync(itemset(7),data(7,b+1)+singlechangereal);
        %         end
        %         if data(31,b+1) >= 10000
        %             writeasync(itemset(26),data(26,b+1)+singlechangereal);
        %         end
        %         if data(50,b+1) >= 10000
        %             writeasync(itemset(45),data(45,b+1)+singlechangereal);
        %         end
        %     end
        % end
        if b > 3
            data(106,b+1) = data(15,b+1)-data(15,b);
            data(107,b+1) = data(7,b+1)-data(7,b);
            data(108,b+1) = data(26,b+1)-data(26,b);
            data(109,b+1) = data(45,b+1)-data(45,b);
        end
        % dasda = max_burning(4);
        ...
        cntcycle = 3; %paramdata.commdata(1).parameter(5).ATTRIBUTE.cntcycle; %模糊、pid计算周期
        ...
        if tempswitch(3)==1
            tp3 = data(43,b+1);  %主：3#小炉拱顶温度
        else
            tp3 = data(71,b+1);   %备：3#小炉燃烧室S偶温度
        end
        ...
        if gas_co >= 29
            default_airgaspotial_set2 = [0.8 0.75 0.82];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 29
                default_airgaspotial2 = [0.8 0.75 0.82];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        elseif gas_co >= 27
            default_airgaspotial_set2 = [0.78 0.73 0.78];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 27 || data(60,b) >= 29
                default_airgaspotial2 = [0.78 0.73 0.78];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        elseif gas_co >= 25
            default_airgaspotial_set2 = [0.76 0.71 0.76];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 25 || data(60,b) >= 27
                default_airgaspotial2 = [0.76 0.71 0.76];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
            ...
            % elseif gas_co >= 26.5
            %     default_airgaspotial_set2 = [0.71 0.7 0.63];
            %     %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            %     if data(60,b) < 26.5 || data(60,b) >= 27
            %         default_airgaspotial2 = [0.71 0.7 0.63];
            % %         default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
            % %         default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
            % %         default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            %     end
            ...
            % elseif gas_co >= 26
            %     default_airgaspotial_set2 = [0.7 0.7 0.62];
            %     %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            %     if data(60,b) < 26 || data(60,b) >= 26.5
            %         default_airgaspotial2 = [0.7 0.7 0.62];
            % %         default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
            % %         default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
            % %         default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            %     end
            % elseif gas_co >= 25.5
            %     default_airgaspotial_set2 = [0.7 0.68 0.61];
            %     %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            %     if data(60,b) < 25 || data(60,b) >= 26
            %         default_airgaspotial2 = [0.7 0.68 0.61];
            % %         default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
            % %         default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
            % %         default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            %     end
            % elseif gas_co >= 25
            %     default_airgaspotial_set2 = [0.68 0.67 0.6];
            %     %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            %     if data(60,b) < 25 || data(60,b) >= 26
            %         default_airgaspotial2 = [0.68 0.67 0.6];
            % %         default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
            % %         default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
            % %         default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            %     end
            ...
            % elseif gas_co >= 24
            %     default_airgaspotial_set2 = [0.68 0.67 0.58];
            %     %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            %     if data(60,b) < 24 || data(60,b) >= 25
            %         default_airgaspotial2 = [0.68 0.67 0.58];
            % %         default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
            % %         default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
            % %         default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            %     end
        ...
        elseif gas_co >= 23
            default_airgaspotial_set2 = [0.74 0.69 0.76];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 23 || data(60,b) >= 25
                default_airgaspotial2 = [0.74 0.69 0.76];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        ...
        elseif gas_co >= 22.5
            default_airgaspotial_set2 = [0.72 0.67 0.78];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 22.5 || data(60,b) >= 23.5
                default_airgaspotial2 = [0.72 0.67 0.78];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        ...
        elseif gas_co >= 22
            default_airgaspotial_set2 = [0.7 0.65 0.76];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 22 || data(60,b) >= 22.5
                default_airgaspotial2 = [0.7 0.65 0.76];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        ...
        elseif gas_co >= 21
            default_airgaspotial_set2 = [0.68 0.63 0.74];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 21 || data(60,b) >= 22
                default_airgaspotial2 = [0.68 0.63 0.74];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        ...
        elseif gas_co >= 20
            default_airgaspotial_set2 = [0.66 0.61 0.72];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 20 || data(60,b) >= 21
                default_airgaspotial2 = [0.66 0.61 0.72];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        ...
        elseif gas_co >= 19
            default_airgaspotial_set2 = [0.64 0.59 0.7];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) < 19 || data(60,b) >= 20
                default_airgaspotial2 = [0.64 0.59 0.7];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
            ...
            default_airgaspotial_set2 = [0.62 0.57 0.68];
            %持续在该范围，空燃比保持已经自寻优结果;否则重置到该范围空燃比
            if data(60,b) >= 19
                default_airgaspotial2 = [0.62 0.57 0.68];
                default_airgaspotial(1) = default_airgaspotial2(1) + zeng1;
                default_airgaspotial(2) = default_airgaspotial2(2) + zeng2;
                default_airgaspotial(3) = default_airgaspotial2(3) + zeng3;
            end
        ...
        default_airgaspotial_set(1) = default_airgaspotial_set2(1) + zeng1;
        default_airgaspotial_set(2) = default_airgaspotial_set2(2) + zeng2;
        default_airgaspotial_set(3) = default_airgaspotial_set2(3) + zeng3;
        min_airgaspotial(1)=default_airgaspotial_set(1)-0.005;
        min_airgaspotial(2)=default_airgaspotial_set(2)-0.005;
        min_airgaspotial(3)=default_airgaspotial_set(3)-0.005;
        
        max_airgaspotial(1)=default_airgaspotial_set(1)+0.005;
        max_airgaspotial(2)=default_airgaspotial_set(2)+0.005;
        max_airgaspotial(3)=default_airgaspotial_set(3)+0.005;
        ...
        errorpos=5;
        %% 获取补偿流量
        flow_buchang(1) = str2double(get(handles.flow_buchang,'String'));
        flow_buchang(2) = str2double(get(handles.flow_buchang2,'String'));
        flow_buchang(3) = str2double(get(handles.flow_buchang3,'String'));
        data(99,b+1)=flow_buchang(1);
        data(100,b+1)=flow_buchang(2);
        data(101,b+1)=flow_buchang(3);
        %% 获取各段温度,压力设定值,煤气空气流量测量值
        tsp=[ts1-5;ts2-5;ts3-5];
        ...
        if max_burning(1) == 1
            ...
            set(handles.text284,'Visible','on');
            set(handles.text285,'Visible','on');
            set(handles.apc_1_off,'BackgroundColor',[0.941 0.941 0.941]);
            set(handles.apc_1_on,'BackgroundColor',[0.941 0.941 0.941]);
            set(handles.max_burn1,'BackgroundColor',[0 1 0]);
            set(handles.text284,'String',gd_gas1);
        end
        if max_burning(1) == 0
            set(handles.text284,'Visible','off');
            set(handles.text285,'Visible','off');
        end
        %2#小炉子
        if max_burning(2) == 1
            ff2_max = gd_gas2;
        ...
        if b >= 5   && (max_burning(1) + max_burning(2) + max_burning(3)) <= 1 ...
            ...
            if songfenging1 == 1 && songfenging2 == 0 && songfenging3 == 0 && gasmean(2) >= 5000% 1号炉送风
                if feiqi_avg2 <= wendu_max2-15 % 此时 2# 为主
                    ff3 = ff3 * 0.9;
                    ff3_max = ff3_max * 0.9;
                elseif feiqi_avg2 <= wendu_max2-14
                    ff2 =  ff2 * 0.8;
                    ff2_max = ff2_max * 0.8;
            ...
            if songfenging2 == 1 && songfenging1 == 0 && songfenging3 == 0 && gasmean(3) >= 15000% 2号炉送风
                if feiqi_avg3 <= wendu_max3-20 % 此时 3# 为主
                    ff1 =  ff1 *0.9; %gasmean(3) * 0.9;
                    ff1_max = ff1_max * 0.9;%gasmean(3) * 0.9;
                elseif feiqi_avg3 <= wendu_max3-19
                    ff3 =  ff3 * 0.8;
                    ff3_max = ff3_max * 0.8;
            ...
            if songfenging3 == 1 && songfenging2 == 0 && songfenging1 == 0 && gasmean(1) >= 15000% 3号炉送风
                if feiqi_avg1<= wendu_max1-15 % 此时 1# 为主
                    ff2 = ff2*0.9;  %gasmean(1) * 0.7;
                    ff2_max =ff2_max*0.9; %gasmean(1) * 0.7;
                elseif feiqi_avg1 <= wendu_max1-14
                    ff1 =  ff1 * 0.8;
                    ff1_max = ff1_max * 0.8;
            ...
            if(mod(b,2)==0)
                ...
                if b>32
                    ...
                    if tempswitch(3)==1
                        ...
                        gdtemp_sum3_1=sum(data(71,b-3:b+1)); %连续5s的拱顶温度
                        gdtemp_sum3_2=sum(data(71,b-8:b-4));
                    end
                    ...
                    if tempswitch(3)==1
                        gdwendu(3)=(sum(data(43,b-13:b+1)))/15; %43
                    else
                        gdwendu(3)=(sum(data(71,b-13:b+1)))/15;
                    end
                else
                    if tempswitch(1)==1
                    ...
                    if tempswitch(3)==1
                        gdwendu(3)=data(43,b+1);%43
                    else
                        gdwendu(3)=data(71,b+1);
                    end
                end
                % 加减烧流量补偿
                if data(99,b+1) ~= data(99,b)
                    tempu(1) = tempu(1) + flow_buchang(1) * default_airgaspotial(1);
                end
                if data(100,b+1) ~= data(100,b)
                    tempu(2) = tempu(2) + flow_buchang(2) * default_airgaspotial(2);
                end
                if data(101,b+1) ~= data(101,b)
                    tempu(3) = tempu(3) + flow_buchang(3) * default_airgaspotial(3);
                end
        ...
        for i=1:3
            ...
            switch i
                case 1                              % 1#
                    if(gdwendu(i)>tsp(i)&&gdwendu(i)<tsp(i)+4) %拱顶温度大于设定值减5且小于减5加4 1392 < gdt < 1396
                        default_airgaspotial(1)=default_airgaspotial_set(1)+0.03; %默认空燃比加0.03
                    elseif(gdwendu(i)>=tsp(i)+4&&gdwendu(i)<tsp(i)+8) %1396 < gdt < 1400
                        default_airgaspotial(1)=default_airgaspotial_set(1)+0.06;
                    elseif(gdwendu(i)>=tsp(i)+8&&gdwendu(i)<tsp(i)+10)
                        default_airgaspotial(1)=default_airgaspotial_set(1)+0.08;
                    ...
                    elseif(gdwendu(i)>=tsp(i)+12)
                        default_airgaspotial(1)=default_airgaspotial_set(1)+0.15;
                    ...
                    if(gap_on(1)==1)
                        ...
                        gassp(i)=tempu(i)./default_airgaspotial(1); %./为两个矩阵按位置相除
                    else
                        gassp(i)=tempu(i)./default_airgaspotial(i);
                    end
                    
                    if gassp(i) >= pidloop(1,1) + liuliangzhenfu % 限制振幅
                ...
                case 2                                  % 2#
                    if(gdwendu(i)>tsp(i)&&gdwendu(i)<tsp(i)+4)
                        default_airgaspotial(2)=default_airgaspotial_set(2)+0.03;
                    elseif(gdwendu(i)>=tsp(i)+4&&gdwendu(i)<tsp(i)+8)
                        default_airgaspotial(2)=default_airgaspotial_set(2)+0.06;
                    elseif(gdwendu(i)>=tsp(i)+8&&gdwendu(i)<tsp(i)+10)
                        default_airgaspotial(2)=default_airgaspotial_set(2)+0.09;
                    elseif(gdwendu(i)>=tsp(i)+10&&gdwendu(i)<tsp(i)+12)
                        default_airgaspotial(2)=default_airgaspotial_set(2)+0.12;
                    elseif(gdwendu(i)>=tsp(i)+12)
                        default_airgaspotial(2)=default_airgaspotial_set(2)+0.15;
                ...
                case 3                                  % 3# kongranbi
                    if(gdwendu(i)>tsp(i)+1&&gdwendu(i)<tsp(i)+4)
                        default_airgaspotial(3)=default_airgaspotial_set(3)+0.03;
                    elseif(gdwendu(i)>=tsp(i)+4&&gdwendu(i)<tsp(i)+8)
                        default_airgaspotial(3)=default_airgaspotial_set(3)+0.6;
                    elseif(gdwendu(i)>=tsp(i)+8&&gdwendu(i)<tsp(i)+10)
                        default_airgaspotial(3)=default_airgaspotial_set(3)+0.09;
                    elseif(gdwendu(i)>=tsp(i)+10&&gdwendu(i)<tsp(i)+12)
                        default_airgaspotial(3)=default_airgaspotial_set(3)+0.12;
                    elseif(gdwendu(i)>=tsp(i)+12)
                        default_airgaspotial(3)=default_airgaspotial_set(3)+0.15;
        ...
        if(gdwendu(1)>=tsp(1)+5)
            default_airgaspotial(1)=default_airgaspotial_set(1)+0.1;
            max_airgaspotial(1)=default_airgaspotial_set(1)+0.1;
        end
        if(gdwendu(1)>=tsp(1)+8)
            default_airgaspotial(1)=default_airgaspotial_set(1)+0.15;
            max_airgaspotial(1)=default_airgaspotial_set(1)+0.15;
        end
        if(gdwendu(1)>=tsp(1)+12)
            default_airgaspotial(1)=default_airgaspotial_set(1)+0.2;
            max_airgaspotial(1)=default_airgaspotial_set(1)+0.2;
        end
        ...
        if(gdwendu(2)>=tsp(2)+8)
            default_airgaspotial(2)=default_airgaspotial_set(2)+0.15;
            max_airgaspotial(2)=default_airgaspotial_set(2)+0.15;
        end
        if(gdwendu(2)>=tsp(2)+12)
            default_airgaspotial(2)=default_airgaspotial_set(2)+0.2;
            max_airgaspotial(2)=default_airgaspotial_set(2)+0.2;
        end
        ...
        if(gdwendu(2)>=tsp(2)+18)
            default_airgaspotial(2)=default_airgaspotial_set(2)+0.3;
            max_airgaspotial(2)=default_airgaspotial_set(2)+0.3;
        end
        if(gdwendu(2)>=tsp(2)+20)
        ...
        if(gdwendu(3)>=tsp(3)+5)
            default_airgaspotial(3)=default_airgaspotial_set(3)+0.1;
            max_airgaspotial(3)=default_airgaspotial_set(3)+0.1;
        end
        if(gdwendu(3)>=tsp(3)+8)
            default_airgaspotial(3)=default_airgaspotial_set(3)+0.15;
            max_airgaspotial(3)=default_airgaspotial_set(3)+0.15;
        end
        if(gdwendu(3)>=tsp(3)+12)
            default_airgaspotial(3)=default_airgaspotial_set(3)+0.2;
            max_airgaspotial(3)=default_airgaspotial_set(3)+0.2;
        end
        if(gdwendu(3)>=tsp(3)+15)
            default_airgaspotial(3)=default_airgaspotial_set(3)+0.25;
            max_airgaspotial(3)=default_airgaspotial_set(3)+0.25;
        end
        if(gdwendu(3)>=tsp(3)+18)
            default_airgaspotial(3)=default_airgaspotial_set(3)+0.3;
            max_airgaspotial(3)=default_airgaspotial_set(3)+0.3;
        end
        if(gdwendu(3)>=tsp(3)+20)
            default_airgaspotial(3)=default_airgaspotial_set(3)+0.35;
            max_airgaspotial(3)=default_airgaspotial_set(3)+0.35;
        end
        ...
        %煤气流量滤波
        if b> 30
            data(110,b+1) = mean(data(12,b-3:b+1));
            data(111,b+1) = mean(data(31,b-3:b+1));
            data(112,b+1) = mean(data(50,b-8:b+1));
        else
            data(110,b+1) = data(12,b+1);
            data(111,b+1) = data(31,b+1);
            data(112,b+1) = data(50,b+1);
        end
        pidloop(2,1)=data(110,b+1);%gasmean(1);                          % 煤气、空气流量滤波后的测量值==
        pidloop(2,2)=data(111,b+1);%gasmean(2);
        pidloop(2,3)=data(112,b+1);%gasmean(3);
        ...
        if b>=20
            ...
            for i=1:3
                if temp_open(i)==1
                    switch i
                        case 1
                            if (tp_1 >= ts_1)&&(sum(airmv(i,:)<=air1_down)==5)&&(airmean(i)>tempu(i))    %当实际温度大于设定温度时且空气气阀门连续五秒为零时，空气设定值等于实际值 ，此时PID输出为零
                                pidloop(1,4)=airmean(i);
                                tempu(i)=airmean(i);
                                
                            end
                            if (min_burning(i)==1)&&(sum(airmv(i,:)<=air1_down)==5)&&(airmean(i)>gas_lower1*default_airgaspotial(i))
                                pidloop(1,4)=airmean(i);
                                tempu(i)=airmean(i);
                            end
                        ...
                        case 2
                            if (tp_2 >= ts_2)&&(sum(airmv(i,:)<=air2_down)==5)&&(airmean(i)>tempu(i))    %当实际温度大于设定温度时且煤气阀门连续五秒为零时，煤气设定值等于实际值 ，此时PID输出为零
                                pidloop(1,5)=airmean(i);
                                tempu(i)=airmean(i);
                            end
                            if (min_burning(i)==1)&&(sum(airmv(i,:)<=air2_down)==5)&&(airmean(i)>gas_lower2*default_airgaspotial(i))
                                pidloop(1,5)=airmean(i);
                                tempu(i)=airmean(i);
                            end
                        ...
                        case 3
                            if (tp_3 >= ts_3)&&(sum(airmv(i,:)<=air3_down)==5)&&(airmean(i)>tempu(i))    %当实际温度大于设定温度时且煤气阀门连续五秒为零时，煤气设定值等于实际值 ，此时PID输出为零
                                pidloop(1,6)=airmean(i);
                                tempu(i)=airmean(i);
                                
                            end
                            if (min_burning(i)==1)&&(sum(airmv(i,:)<=air3_down)==5)&&(airmean(i)>gas_lower3*default_airgaspotial(i))
                                pidloop(1,6)=airmean(i);
                                tempu(i)=airmean(i);
                            end
        ...
        %  1#空气阀门
        if abs(pidloop(1,4) - pidloop(2,4)) >= 20000
            pidloop(7,4)=paramdata.furnacetype(1).parameter(3).ATTRIBUTE.airPara1_3;
            pidloop(8,4)=paramdata.furnacetype(1).parameter(3).ATTRIBUTE.airPara1;
            pidloop(13,4)=0.5;
        elseif abs(pidloop(1,4) - pidloop(2,4)) >= 10000
            pidloop(7,4)=paramdata.furnacetype(1).parameter(3).ATTRIBUTE.airPara1_2;
            pidloop(8,4)=paramdata.furnacetype(1).parameter(3).ATTRIBUTE.airPara1;
            pidloop(13,4)=0.5;
        else
        ...
        if abs(pidloop(1,5) - pidloop(2,5)) >= 20000
            pidloop(7,5)=paramdata.furnacetype(2).parameter(3).ATTRIBUTE.airPara2_3;  %空气
            pidloop(8,5)=paramdata.furnacetype(2).parameter(3).ATTRIBUTE.airPara2;
            pidloop(13,5)=0.5;
        elseif abs(pidloop(1,5) - pidloop(2,5)) >= 10000
            pidloop(7,5)=paramdata.furnacetype(2).parameter(3).ATTRIBUTE.airPara2_2;  %空气
            pidloop(8,5)=paramdata.furnacetype(2).parameter(3).ATTRIBUTE.airPara2;
            pidloop(13,5)=0.5;
        else
        ...
        if abs(pidloop(1,6) - pidloop(2,6)) >= 20000
            pidloop(7,6)=paramdata.furnacetype(3).parameter(3).ATTRIBUTE.airPara3_3;  %空气
            pidloop(8,6)=paramdata.furnacetype(3).parameter(3).ATTRIBUTE.airPara3;
            pidloop(13,6)=0.5;
        elseif abs(pidloop(1,6) - pidloop(2,6)) >= 10000
            pidloop(7,6)=paramdata.furnacetype(3).parameter(3).ATTRIBUTE.airPara3_2;  %空气
            pidloop(8,6)=paramdata.furnacetype(3).parameter(3).ATTRIBUTE.airPara3;
            pidloop(13,6)=0.5;
        else
        ...
        if b > 15 && mod(b,15) == 0
            if ((gasmean(1) > 3000 && gasmean(2) <= 100 && gasmean(3) <= 100 ) ||...  %只有一个小炉处于烧炉状态时
                ...
                elseif avg_gas <= 11.5
                    air_pressure = 9.1;
                elseif avg_gas <= 12.5
                    air_pressure = 9.3; %9.3
                elseif avg_gas <= 15
                    air_pressure = 9.3; %9.5
                else
                    air_pressure = 9.5;
                end
            else  %两个炉子处于烧炉状态时
        ...
        if (mod(b,pidmodcnt)==0) %由于阀门反馈跟随较慢，减缓计算周期
            ...
            %     data(101,b+1) = pidloop(3,1);
            %     data(102,b+1) = pidloop(3,2);
            %     data(103,b+1) = pidloop(3,3);
            %     data(104,b+1) = pidloop(3,4);
            %     data(105,b+1) = pidloop(3,5);
            %     data(106,b+1) = pidloop(3,6);
            %     dt(1,b) = pidloop(3,1)-data(101,b);
            %     dt(2,b) = pidloop(3,2)-data(102,b);
            %     dt(3,b) = pidloop(3,3)-data(103,b);
            %     dt(4,b) = pidloop(3,4)-data(104,b);
            %     dt(5,b) = pidloop(3,5)-data(105,b);
            %     dt(6,b) = pidloop(3,6)-data(106,b);
            %控制振幅大小
            if pidloop(3,1)-data(1,b+1) >= famenzhenfu
                pidloop(3,1) = data(1,b+1) + famenzhenfu;
            elseif pidloop(3,1)-data(1,b+1) <= -famenzhenfu
                pidloop(3,1) = data(1,b+1) - famenzhenfu;
            end
            if pidloop(3,2)-data(20,b+1) >= famenzhenfu
                pidloop(3,2) = data(20,b+1) + famenzhenfu;
            elseif pidloop(3,2)-data(20,b+1) <= -famenzhenfu
                pidloop(3,2) = data(20,b+1) - famenzhenfu;
            end
            if pidloop(3,3)-data(39,b+1) >= famenzhenfu
                pidloop(3,3) = data(39,b+1) + famenzhenfu;
            elseif pidloop(3,3)-data(39,b+1) <= -famenzhenfu
                pidloop(3,3) = data(39,b+1) - famenzhenfu;
            end
        ...
        %% 逻辑控制煤气阀门 帮助快速变化
        %3#小炉逻辑单独控制
        if mod(b,15) == 0 && pidloop(2,3) - pidloop(1,3) >= 8000 %20s扫描一次，如果煤气实际值大于设定值2500，阀门减3个
            pidloop(3,3) = pidloop(3,3) - 3;
        elseif mod(b,15) == 0 && pidloop(2,3) - pidloop(1,3) >= 6000 %20s扫描一次，如果煤气实际值大于设定值2500，阀门减3个
            pidloop(3,3) = pidloop(3,3) - 2;
        end
        if mod(b,13) == 0 && pidloop(1,3) - pidloop(2,3) >= 3500 %20s扫描一次，如果空气设定值大于实际值3000，阀门加4个
            pidloop(3,3) = pidloop(3,3) + 2;
        end
        
        
        for i = 1:2
            if mod(b,13) == 0 && pidloop(2,i) - pidloop(1,i) >= 5000 %20s扫描一次，如果煤气实际值大于设定值2500，阀门减3个
                pidloop(3,i) = pidloop(3,i) - 3;
            elseif mod(b,13) == 0 && pidloop(2,i) - pidloop(1,i) >= 4000 %20s扫描一次，如果煤气实际值大于设定值2500，阀门减3个
                pidloop(3,i) = pidloop(3,i) - 2;
            end
            
            if mod(b,13) == 0 && pidloop(1,i) - pidloop(2,i) >= 3000 %20s扫描一次，如果空气设定值大于实际值3000，阀门加4个
                pidloop(3,i) = pidloop(3,i) + 2;
            end
        end
        ...
        for i = 4:6
            if mod(b,13) == 0 && pidloop(2,i) - pidloop(1,i) >= 6000 %20s扫描一次，如果空气实际值大于设定值3000，阀门减4个
                pidloop(3,i) = pidloop(3,i) - 4;
            elseif mod(b,13) == 0 && pidloop(2,i) - pidloop(1,i) >= 5000 %20s扫描一次，如果空气实际值大于设定值3000，阀门减4个
                pidloop(3,i) = pidloop(3,i) - 3;
            elseif mod(b,13) == 0 && pidloop(2,i) - pidloop(1,i) >= 4000 %20s扫描一次，如果空气实际值大于设定值3000，阀门减4个
                pidloop(3,i) = pidloop(3,i) - 2;
            end
            
            if mod(b,13) == 0 && pidloop(1,i) - pidloop(2,i) >= 4000 %20s扫描一次，如果空气设定值大于实际值3000，阀门加4个
                pidloop(3,i) = pidloop(3,i) + 3;
            end
        ...
        for i=1:loopnum
            switch i
                ...
                case 6
                    if pidloop(10,i)==0 && (mod(b,2)==0)              % 减缓均热空气阀的动作
                        if abs(upid(i)-upid_old(i))>=deadzone(2)
                            upid(i)=round(upid(i));
